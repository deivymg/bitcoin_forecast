...
| Processed Binance API | [API data acquisition and processing](/scripts/data_acquisition/main.py) |[Limpieza de datos](/scripts/preprocessing/main.py )| [Processed Binance DATA](/scripts/data_acquisition/ultimos_15_minutos.csv)|
