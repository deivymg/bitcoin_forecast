...
| Processed Binance API | [API data acquisition and proccessing](link/scripts/data_acquisition/main.py) |[data a](link/scripts/data_acquisition/ultimos_15_minutos.csv) | [Processed Binance DATA](link/to/report2)|
